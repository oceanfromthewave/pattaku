...
// 스케줄 댓글 수정
export const updateScheduleComment = async (
  scheduleId,
  commentId,
  commentData
) => {
  const response = await apiClient.put(
    `/api/schedules/${scheduleId}/comments/${commentId}`,
    commentData
  );
  return response.data;
};
...
export const likeScheduleComment = async (scheduleId, commentId) => {
  const response = await apiClient.post(
    `/api/schedules/${scheduleId}/comments/${commentId}/like`
  );
  return response.data;
};
...
export const dislikeScheduleComment = async (scheduleId, commentId) => {
  const response = await apiClient.post(
    `/api/schedules/${scheduleId}/comments/${commentId}/dislike`
  );
  return response.data;
};
...
export const getUserScheduleComments = async (params = {}) => {
  const response = await apiClient.get("/api/user/schedule-comments", {
    params,
  });
  return response.data;
};
