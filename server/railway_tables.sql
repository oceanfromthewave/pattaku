-- ============================================
-- 패타쿠 Railway MySQL 테이블 생성 스크립트
-- ============================================
-- Railway > MySQL Service > Query 탭에서 실행하세요
-- ============================================
...
CREATE TABLE schedule_comment_likes (
  id INT AUTO_INCREMENT PRIMARY KEY,
  comment_id INT NOT NULL,
  user_id INT NOT NULL,
  vote_type ENUM('like', 'dislike') NOT NULL,
...
-- 완료 확인
SELECT 'Railway MySQL 테이블 생성 완료! 🎉' as status;

-- ============================================
-- 다음 단계:
-- 1. Render에서 백엔드 재배포 (새 DB 설정 적용)
